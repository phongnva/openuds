#!/bin/bash
# =============================================================================
# Build script for UDS Client macOS Apple Silicon (arm64) DMG
# Usage: cd uds-client/src && bash build-macos-arm64-dmg.sh
# =============================================================================
...
APP_VERSION="4.0.0"
DMG_NAME="FSOFT-VDC-${APP_VERSION}-macOS-AppleSilicon"
VENV_DIR="${SCRIPT_DIR}/build_venv_arm64"

echo "============================================"
echo "  FSOFT Virtual Desktop Client macOS Apple Silicon Build"
...
pip install --no-compile PySide6 psutil cryptography certifi pyinstaller 
...
pyinstaller UDSClient-macOS-arm64.spec --clean --noconfirm
